# Using packages - tm and igraph
library(tm)
library(igraph)

#file="C:/College/Summer 2021/webscraping/SocialMediaAnalytics/Twitter/results.csv"
...
# Corpus is a set of words in the documents 
...
# A matrix of the frequency of the words 
tdm = TermDocumentMatrix(text_corpus)
m = as.matrix(tdm)

# remove sparse terms (word frequency > 90% percentile) such as common words 'the' 
wf = rowSums(m)
...
# change it to a Boolean matrix  m[m>=1] <- 1
