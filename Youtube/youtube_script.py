...
developer_key = input(" Enter your credentials")
...
def youtube_search(query):  # Given a query
    ...
    file = open('youtube_result.csv', 'w') # creating a new csv file
    ...
    stats = youtube.videos().list(part="statistics", id = "id=-biOGdYiF-I").execute()    # calls video query
